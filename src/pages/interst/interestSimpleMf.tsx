...
export function InterestSimpleMf() {
    ...
    const onSubmit = (data: FormData) => {
        ...
        const nuevoValorFuturo = data.capital * (1 + (tasaDecimal * tiempo));
        setValorFuturo(nuevoValorFuturo);
    };

    return (
        <Col css={{ padding: '2rem' }}>
            <Text h1 size={30} color='#ffffff' css={{ letterSpacing: '1px', fontWeight: '$thin', marginTop: '2rem' }}>Calcular Monto Final</Text>
            <Spacer y={1.2} />
